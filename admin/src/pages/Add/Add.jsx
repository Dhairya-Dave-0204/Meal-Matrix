  ...
  return (
    <div className="w-[70%] ml-5 mt-5 md:ml-16 md:mt-14 text-lg add">
      <form action="#" className="gap-5 cloumns" onSubmit={onSubmitHandler}>
        ...
        <div className="flex gap-8">
          <div className="columns">
            ...
            <select
              name="category"
              id="category"
              className="max-w-[120px] p-3 border border-black focus:border-primary"
              onChange={onChangeHandler}
            >
        ...
        <button
          type="submit"
          className="max-w-[120px] border-none py-2 px-11 rounded-lg font-medium bg-black text-white cursor-pointer"
        >
          ADD
        </button>
      </form>
